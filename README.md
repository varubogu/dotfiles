...
```bash
bash -c "$( curl -fsSL https://raw.github.com/varubogu/dotfiles/master/.local/bin/dotfiles/setup/setup.bash )"
```

Rootless setup

```bash
bash -c "$( curl -fsSL https://raw.github.com/varubogu/dotfiles/master/.local/bin/dotfiles/setup/setup.bash ) -noroot"
```

Windows setup

```ps1
$scriptUrl = "https://raw.github.com/varubogu/dotfiles/master/.local/bin/dotfiles/setup/setup_win.ps1"
