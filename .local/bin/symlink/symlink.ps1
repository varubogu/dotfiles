...
# 設定ファイルのシンボリックリンクを作成
New-Symlink-Safety -Source "$HOME\.config\git\local.config##os.Windows" -Destination "$HOME\.config\git\local.config"
New-Symlink-Safety -Source "$HOME\.config\.editorconfig" -Destination "$HOME\.editorconfig"
